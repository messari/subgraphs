    ...
    try {
      ...
      return (
        <Grid key={entityName}>
          ...
          <Tooltip placement="top" title={"Overlay chart with data points populated from a .csv file"}><UploadFileCSV csvMetaData={csvMetaData} field={entityName} csvJSON={csvJSON} setCsvJSON={setCsvJSON} setChartIsImage={(x: any) => console.log(x)} setCsvMetaData={setCsvMetaData} /></Tooltip>
          <div>
