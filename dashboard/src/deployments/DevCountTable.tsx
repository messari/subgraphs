                    ...
                    <TableBody>
                        ...
                        <TableRow>
                            ...
                            </TableCell>
                            {
                                Object.keys(subgraphCounts).map(schemaType => {
                                    const deployStats = subgraphCounts[schemaType];
                                    return (<TableCell style={{ textAlign: "right", padding: "3px" }} key={schemaType + 'TotalCountCell'}>
                                        <span style={{ fontSize: "14px", textAlign: "right", width: "100%" }}>{deployStats.totalCount}</span>
                                    </TableCell>)
                                })
                            }
                        </TableRow>
