...
4. To direct the existing methodology to gitbooks, enter the protocol name and repository path in the format: `[protocol name](protocol/blah/READ.ME)` (You do not need to add `/subgraphs/` to the path as it is automatically included)
