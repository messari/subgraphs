...
export function getPreviousDaysSinceEpoch(secondsSinceEpoch: number): string {
  return (<i32>Math.floor((secondsSinceEpoch - SECONDS_PER_DAY) / SECONDS_PER_DAY)).toString();
}
