...
import { ERC20 } from "../../generated/LRTVault/ERC20";
import { bigIntToBigDecimal } from "../sdk/util/numbers";
import { getUsdPrice, getUsdPricePerToken } from "../prices";
import { LRTVault } from "../../generated/LRTVault/LRTVault";
...
export function updatePoolTVL(pool: Pool): void {
  const vaultContract = AmphorAsyncVault.bind(
...
export function updatePoolTvlForLRTVaults(pool: Pool): void {
  const vaultContract = LRTVault.bind(Address.fromBytes(pool.getBytesID()));
