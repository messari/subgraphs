...
// Unused rollback handlers (we don't track if a contract has been rolled back, this is FEI specific)
export function handleRollback(event: Rollback): void {}
export function handleRollbackQueued(event: RollbackQueued): void {}
