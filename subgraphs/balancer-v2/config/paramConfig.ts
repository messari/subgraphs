...
if (dataSource.network() == Network.MAINNET.toLowerCase()) {
  PROTOCOL_SLUG_TEMP = "balancer-v2";

  DEPLOYED_NETWORK_TEMP = Network.MAINNET;
  FACTORY_ADDRESS_TEMP = "0xBA12222222228d8Ba445958a75a0704d566BF2C8";
