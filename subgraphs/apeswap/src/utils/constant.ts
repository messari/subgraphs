import { ethereum, BigDecimal, BigInt, Address, dataSource } from "@graphprotocol/graph-ts";
...
export function normalizedUsdPrice(usdcPrice: BigInt): BigDecimal {
  return usdcPrice.toBigDecimal().div(USD_DENOMINATOR)
}
