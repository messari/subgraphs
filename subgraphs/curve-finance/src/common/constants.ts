...
export const PRICE_CACHING_BLOCKS = BigInt.fromI32(25000);
...
export const POOL_REGISTRIES: Address[] = [
  Address.fromString("0x094d12e5b541784701FD8d65F11fc0598FBC6332"), // MainRegistry
  Address.fromString("0x722272D36ef0Da72FF51c5A65Db7b870E2e8D4ee"), // StableSwapFactory
  Address.fromString("0x47bB542B9dE58b970bA50c9dae444DDB4c16751a"), // CryptoSwapRegistry
  Address.fromString("0xE5De15A9C9bBedb4F5EC13B131E61245f2983A69"), // CryptoPoolFactory
]
