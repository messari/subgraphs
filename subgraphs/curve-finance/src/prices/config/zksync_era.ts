...
export const NETWORK_STRING = "zksync-era";
...
export const UNISWAP_FORKS_ROUTER_ADDRESSES: OracleContract[] = [
  new OracleContract("0x5aeaf2883fbf30f3d62471154eda3c0c1b05942d", 8637850),
  new OracleContract("0x18381c0f738146fb694de18d1106bde2be040fa4", 4182380),
];
