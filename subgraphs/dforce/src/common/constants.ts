...
// number of decimals in mantissa value
export const MANTISSA_DECIMALS = 18;
// denominator for DistributionFactorMantissa
export const DISTRIBUTIONFACTOR_BASE = 18;
// base for price returned from PriceOracle
export const PRICE_BASE = 18;

// contract addresses
export const FACTORY_ADDRESS = "0x8B53Ab2c0Df3230EA327017C91Eb909f815Ad113";
export const DF_ADDRESS = "0x431ad2ff6a9C365805eBaD47Ee021148d6f7DBe0";
export const iDF_ADDRESS = "0xb3dc7425e63E1855Eb41107134D471DD34d7b239";
export const iETH_ADDRESS = "0x5ACD75f21659a59fFaB9AEBAf350351a8bfaAbc0";

// Creation block of the DF contract
//export const EMISSION_START_BLOCK = BigInt.fromString("");
