...
import { WBETH } from "../../generated/INETH/WBETH";
import { PendlePT } from "../../generated/INETH/PendlePT";
import { PendleSY } from "../../generated/INETH/PendleSY";
import { EigenpieMLRT } from "../../generated/INETH/EigenpieMLRT";
import { SFRAX } from "../../generated/INETH/SFRAX";
import { LRTDepositPool } from "../../generated/INETH/LRTDepositPool";
...
export function getUpdatedPricedToken(tokenAddr: Address): PricedTokenParams {
  ...
  if (network == Network.MAINNET) {
    ...
    // Case: inputToken is ezETH or osETH
    if (
      [
    ...
    if (
      ...
      const lrtDepositContract = LRTDepositPool.bind(
        Address.fromString("0x036676389e48133b63a802f8635ad39e752d375d")
      );
