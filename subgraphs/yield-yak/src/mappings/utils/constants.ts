...
export let ZERO_BIGDECIMAL: BigDecimal = BigDecimal.fromString("0");

export let DEFUALT_DECIMALS: BigInt = BigInt.fromString("0");
export let DEFUALT_AMOUNT: BigInt = BigInt.fromString("1000000000000000000")
...
export let YakStrategyManagerV1: Address = toAddress("0x302404cb8F34713A8B8DBF9b4989A41252332068");