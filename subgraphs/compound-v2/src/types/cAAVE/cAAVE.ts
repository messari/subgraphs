...
export class cAAVE__getAccountSnapshotResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class cAAVE extends ethereum.SmartContract {
  static bind(address: Address): cAAVE {
    return new cAAVE("cAAVE", address);
  }
  ...
  getAccountSnapshot(account: Address): cAAVE__getAccountSnapshotResult {
    let result = super.call(
      "getAccountSnapshot",
    ...
    return new cAAVE__getAccountSnapshotResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_getAccountSnapshot(
    account: Address
  ): ethereum.CallResult<cAAVE__getAccountSnapshotResult> {
    let result = super.tryCall(
      "getAccountSnapshot",
      "getAccountSnapshot(address):(uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(account)]
    ...
    return ethereum.CallResult.fromValue(
      new cAAVE__getAccountSnapshotResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
