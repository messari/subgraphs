...
let MINIMUM_ETH_LOCKED_TEMP: BigDecimal     // Minimum amount of native token to be tracked
...
if (dataSource.network() == SubgraphNetwork.ETHEREUM) {
    ...
    MINIMUM_ETH_LOCKED_TEMP = BigDecimal.fromString('60')
    ...
    MINIMUM_ETH_LOCKED_TEMP = BigDecimal.fromString('5')
...
export namespace NetworkParameters {
    ...
    export const MINIMUM_ETH_LOCKED = MINIMUM_ETH_LOCKED_TEMP
}
