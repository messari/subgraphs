...
import { LooksrareEthereumConfigurations } from "../../protocols/looksrare/config/deployments/looksrare-ethereum/configurations";
...
export function getNetworkConfigurations(deploy: i32): Configurations {
  switch (deploy) {
    case Deploy.LOOKSRARE_ETHEREUM: {
      return new LooksrareEthereumConfigurations();
    }
    default: {
      log.critical(
