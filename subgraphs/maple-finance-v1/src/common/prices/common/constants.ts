...
import { UniswapPair__getReservesResult } from "../../../../generated/MapleGlobals/UniswapPair";
import { SushiSwapPair__getReservesResult } from "../../../../generated/MapleGlobals/SushiSwapPair";
...
export const MAPLE_GLOBALS_ADDRESS = new Map<string, string>();
MAPLE_GLOBALS_ADDRESS.set(MAINNET.NETWORK_STRING, MAINNET.MAPLE_GLOBALS_ADDRESS.toHexString());
MAPLE_GLOBALS_ADDRESS.set(FANTOM.NETWORK_STRING, FANTOM.MAPLE_GLOBALS_ADDRESS.toHexString());
MAPLE_GLOBALS_ADDRESS.set(ARBITRUM_ONE.NETWORK_STRING, ARBITRUM_ONE.MAPLE_GLOBALS_ADDRESS.toHexString());
