...
export function getPriceFromRouter(token0Address: Address, token1Address: Address, network: string): CustomPriceType {
    ...
    const routerAddressV1 = constants.UNISWAP_ROUTER_CONTRACT_ADDRESSES.get(network)!.get("routerV1");
    const routerAddressV2 = constants.UNISWAP_ROUTER_CONTRACT_ADDRESSES.get(network)!.get("routerV2");
...
export function getLpTokenPriceUsdc(tokenAddress: Address, network: string): CustomPriceType {
    ...
    const totalSupply = utils.readValue<BigInt>(uniSwapPair.try_totalSupply(), constants.BIGINT_ZERO);
...
export function getLpTokenTotalLiquidityUsdc(tokenAddress: Address, network: string): CustomPriceType {
    ...
    const token0Address = utils.readValue<Address>(uniSwapPair.try_token0(), constants.ZERO_ADDRESS);
    const token1Address = utils.readValue<Address>(uniSwapPair.try_token1(), constants.ZERO_ADDRESS);
