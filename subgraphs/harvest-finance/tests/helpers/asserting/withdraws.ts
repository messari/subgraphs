...
function assertBytes(id: string, field: string, value: Bytes): void {
  assert.fieldEquals('Withdraw', id, field, value.toHexString())
}

function assertBigInt(id: string, field: string, value: BigInt): void {
  assert.fieldEquals('Withdraw', id, field, value.toString())
}
...
function assertString(id: string, field: string, value: string): void {
  assert.fieldEquals('Withdraw', id, field, value)
}
...
export function withdraw(id: string, attributes: AssertEventAttributes): void {
