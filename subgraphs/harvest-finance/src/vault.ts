...
import { Deposit, Vault as VaultContract, Withdraw } from "../../generated/fWETHContract/Vault";
...
export function handleDeposit(event: Deposit): void {
  ...
  log.warning("[Harvest] handleDeposit - vault {}, amount {}, shares {}", [
    vaultAddress.toHex(),
    amount.toString(),
    shares.toString(),
  ]);
...
export function handleWithdraw(event: Withdraw): void {
  ...
  log.warning("[Harvest] handleWithdraw - vault {}, amount {}, shares {}", [
    vaultAddress.toHex(),
    amount.toString(),
    shares.toString(),
  ]);
...
export function createVault(vaultAddress: Address, inputTokenAddress: Address, block: ethereum.Block): Vault {
  ...
  log.warning("[Harvest] vault found : vault {}", [vaultAddress.toHex()]);
