...
export class Pool {
  ...
  initialize(
    ...
    this.pool._feeCollectionAddress = ZERO_ADDRESS;
    this.save();
  ...
  setFeeCollectionAddress(address: string): void {
    this.pool._feeCollectionAddress = address;
    this.save();
  }

  getFeeCollectionAddress(): string {
    return this.pool._feeCollectionAddress;
  }
}
