...
// export class UniswapConfigurations extends Configurations {
//   constructor() {
//     this.network = "";
...
// export const UniswapV2MainnetConfigurations: ConfigurationFields = {
...
//   feeOnOff : FeeSwitch.OFF,
//   rewardIntervalType : RewardIntervalType.NONE,
//   referenceToken : "0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2",
//   rewardToken : "",  
//   whitelistTokens : [
...
UniswapV2MainnetConfigurations.set('network', "mainnet")
UniswapV2MainnetConfigurations.set('protocolName', "Uniswap")
UniswapV2MainnetConfigurations.set('protocolSlug', "uniswap")
UniswapV2MainnetConfigurations.set('factoryAddress', "0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f")
UniswapV2MainnetConfigurations.set('tradingFee', BigDecimal.fromString("3"))
UniswapV2MainnetConfigurations.set('protocolFeeToOn', BigDecimal.fromString("0.5"))
UniswapV2MainnetConfigurations.set('lpFeeToOn', BigDecimal.fromString("2.5"))
UniswapV2MainnetConfigurations.set('protocolFeeToOff', BigDecimal.fromString("0.0"))
UniswapV2MainnetConfigurations.set('lpFeeToOff', BigDecimal.fromString("3"))
UniswapV2MainnetConfigurations.set('feeOnOff', FeeSwitch.OFF)
UniswapV2MainnetConfigurations.set('rewardIntervalType', RewardIntervalType.NONE)
UniswapV2MainnetConfigurations.set('referenceToken', "main0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2net")
UniswapV2MainnetConfigurations.set('rewardToken', "")
UniswapV2MainnetConfigurations.set('whitelistTokens', [
  "0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2", // WETH
  "0x6b175474e89094c44da98b954eedeac495271d0f", // DAI
  "0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48", // USDC
  "0xdac17f958d2ee523a2206206994597c13d831ec7", // USDT
...
UniswapV2MainnetConfigurations.set('stableCoins', [
  "0x6b175474e89094c44da98b954eedeac495271d0f", // DAI
  "0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48", // USDC
  "0xdac17f958d2ee523a2206206994597c13d831ec7", // USDT
  "0x0000000000085d4780b73119b644ae5ecd22b376", // TUSD
...
UniswapV2MainnetConfigurations.set('stableOraclePools', [
  "0xb4e16d0168e52d35cacd2c6185b44281ec28c9dc", // USDC/wETH created 10008355
  "0xa478c2975ab1ea89e8196811f51a7b7ade33eb11", // DAI/wETH created block 10042267
  "0x0d4a11d5eeaac28ec3f61d100daf4d40471f1852", // USDT/wETH created block 10093341
])
UniswapV2MainnetConfigurations.set('untrackedPairs', ["0x9ea3b5b4ec044b70375236a281986106457b20ef"])
