...
if (PROTOCOL_NAME_TEMP == Protocol.UNISWAPV2 && dataSource.network() == Network.MAINNET.toLowerCase()) {
  ...
  FACTORY_ADDRESS_TEMP = "0xc35dadb65012ec5796536bd9864ed8773abc74c4";
  FACTORY_CONTRACT_TEMP = Factory.bind(Address.fromString(FACTORY_ADDRESS_TEMP));
  ...
  NATIVE_TOKEN_TEMP = "0xbb4cdb9cbd36b01bd1cbaebf2de08d9173bc095c";
  REWARD_TOKENS_TEMP = ["0x947950BcC74888a40Ffa2593C5798F11Fc9124C4"];
  WHITELIST_TOKENS_TEMP = [
    "0xbb4cdb9cbd36b01bd1cbaebf2de08d9173bc095c", // wBNB
    "0x2170ed0880ac9a755fd29b2688956bd959f933f8", // wETH
    "0x7130d2a12b9bcbfae4f2634d864a1ee1ce3ead9c", // BTCB
  ...
  STABLE_ORACLE_POOLS_TEMP = [
    "0xc7632b7b2d768bbb30a404e13e1de48d1439ec21", // USDC/wETH
    "0x2905817b020fd35d9d09672946362b62766f0d69", // USDT/wETH
  ...
  FACTORY_ADDRESS_TEMP = "0xc35dadb65012ec5796536bd9864ed8773abc74c4";
  FACTORY_CONTRACT_TEMP = Factory.bind(Address.fromString(FACTORY_ADDRESS_TEMP.toLowerCase()));
