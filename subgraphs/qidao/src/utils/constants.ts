...
export const PROTOCOL_NAME = "QiDao";
export const PROTOCOL_SLUG = "qidao";
...
export const STAKEDAO_STETH_VAULT = Address.fromString(
  "0xcc61Ee649A95F2E2f0830838681f839BDb7CB823"
);
export const YEARN_STETH_VAULT = Address.fromString(
...
export const SECONDS_PER_YEAR = DAYS_PER_YEAR.times(
  new BigDecimal(BigInt.fromI32(SECONDS_PER_DAY))
);
