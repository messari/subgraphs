...
SUSHISWAP_ROUTER_ADDRESS_FANTOM.set(
  "routerV2",
  Address.fromString("0x0000000000000000000000000000000000000000"), // SUSHISWAP_ROUTER_V2_FANTOM
);
...
export const UNISWAP_ROUTER_ADDRESS_ARBITRUM_ONE = new TypedMap<string, Address>();
UNISWAP_ROUTER_ADDRESS_ARBITRUM_ONE.set(
  "routerV1",
  Address.fromString("0x0000000000000000000000000000000000000000"), // UNISWAP_ROUTER_V1_ARBITRUM_ONE
);
UNISWAP_ROUTER_ADDRESS_ARBITRUM_ONE.set(
  "routerV2",
  Address.fromString("0x0000000000000000000000000000000000000000"), // UNISWAP_SWAP_ROUTER_V2_ARBITRUM_ONE
);
...
WHITELIST_TOKENS_FANTOM.set("ETH", Address.fromString("0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE"));
WHITELIST_TOKENS_FANTOM.set("gfUSDT", Address.fromString("0x940f41f0ec9ba1a34cf001cc03347ac092f5f6b5"));
WHITELIST_TOKENS_FANTOM.set("DAI", Address.fromString("0x8d11ec38a3eb5e956b052f67da8bdc9bef8abf3e"));
WHITELIST_TOKENS_FANTOM.set("USDC", Address.fromString("0x04068da6c83afcfa0e13ba15a6696662335d5b75"));
WHITELIST_TOKENS_FANTOM.set("WFTM", Address.fromString("0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83"));
WHITELIST_TOKENS_FANTOM.set("WBTC", Address.fromString("0x321162Cd933E2Be498Cd2267a90534A804051b11"));
WHITELIST_TOKENS_FANTOM.set("fBTC", Address.fromString("0xe1146b9ac456fcbb60644c36fd3f868a9072fc6e"));
WHITELIST_TOKENS_FANTOM.set("FRAX", Address.fromString("0xdc301622e621166bd8e82f2ca0a26c13ad0be355"));
WHITELIST_TOKENS_FANTOM.set("LINK", Address.fromString("0xb3654dc3d10ea7645f8319668e8f54d2574fbdc8"));
WHITELIST_TOKENS_FANTOM.set("CRV", Address.fromString("0x1E4F97b9f9F913c46F1632781732927B9019C68b"));

export const WHITELIST_TOKENS_ARBITRUM_ONE = new TypedMap<string, Address>();
WHITELIST_TOKENS_ARBITRUM_ONE.set("WETH", Address.fromString("0x82af49447d8a07e3bd95bd0d56f35241523fbab1"));
WHITELIST_TOKENS_ARBITRUM_ONE.set("ETH", Address.fromString("0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE"));
WHITELIST_TOKENS_ARBITRUM_ONE.set("USDT", Address.fromString("0xfd086bc7cd5c481dcc9c85ebe478a1c0b69fcbb9"));
WHITELIST_TOKENS_ARBITRUM_ONE.set("DAI", Address.fromString("0xda10009cbd5d07dd0cecc66161fc93d7c9000da1"));
WHITELIST_TOKENS_ARBITRUM_ONE.set("USDC", Address.fromString("0xff970a61a04b1ca14834a43f5de4533ebddb5cc8"));
WHITELIST_TOKENS_ARBITRUM_ONE.set("WBTC", Address.fromString("0x2f2a2543b76a4166549f7aab2e75bef0aefc5b0f"));
WHITELIST_TOKENS_ARBITRUM_ONE.set("LINK", Address.fromString("0xf97f4df75117a78c1a5a0dbb814af92458539fb4"));
