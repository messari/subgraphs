...
CURVE_CALCULATIONS_ADDRESS_MAP.set(BSC.NETWORK_STRING, BSC.CURVE_CALCULATIONS_ADDRESS);
...
CURVE_CALCULATIONS_ADDRESS_MAP.set(POLYGON.NETWORK_STRING, POLYGON.CURVE_CALCULATIONS_ADDRESS);
...
CURVE_REGISTRY_ADDRESS_MAP.set(POLYGON.NETWORK_STRING, POLYGON.CURVE_REGISTRY_ADDRESS);
...
CURVE_POOL_REGISTRY_ADDRESS_MAP.set(BSC.NETWORK_STRING, BSC.CURVE_POOL_REGISTRY_ADDRESS);
...
CURVE_POOL_REGISTRY_ADDRESS_MAP.set(POLYGON.NETWORK_STRING, POLYGON.CURVE_POOL_REGISTRY_ADDRESS);
...
SUSHISWAP_CALCULATIONS_ADDRESS_MAP.set(BSC.NETWORK_STRING, BSC.SUSHISWAP_CALCULATIONS_ADDRESS);
...
SUSHISWAP_CALCULATIONS_ADDRESS_MAP.set(POLYGON.NETWORK_STRING, POLYGON.SUSHISWAP_CALCULATIONS_ADDRESS);
...
SUSHISWAP_WETH_ADDRESS.set(POLYGON.NETWORK_STRING, POLYGON.SUSHISWAP_WETH_ADDRESS);
...
SUSHISWAP_ROUTER_ADDRESS_MAP.set(BSC.NETWORK_STRING, BSC.SUSHISWAP_ROUTER_ADDRESS);
...
SUSHISWAP_ROUTER_ADDRESS_MAP.set(POLYGON.NETWORK_STRING, POLYGON.SUSHISWAP_ROUTER_ADDRESS);
...
UNISWAP_ROUTER_CONTRACT_ADDRESSES.set(BSC.NETWORK_STRING, BSC.UNISWAP_ROUTER_ADDRESS);
...
UNISWAP_ROUTER_CONTRACT_ADDRESSES.set(POLYGON.NETWORK_STRING, POLYGON.QUICKSWAP_ROUTER_ADDRESS);

export const UNISWAP_PATH_OVERRIDES = new TypedMap<string, TypedMap<Address, Address[]>>();
UNISWAP_PATH_OVERRIDES.set(MAINNET.NETWORK_STRING, MAINNET.UNISWAP_PATH_OVERRIDE);
UNISWAP_PATH_OVERRIDES.set(BSC.NETWORK_STRING, BSC.UNISWAP_PATH_OVERRIDE);
UNISWAP_PATH_OVERRIDES.set(FANTOM.NETWORK_STRING, FANTOM.SPOOKY_SWAP_PATH_OVERRIDE);
UNISWAP_PATH_OVERRIDES.set(ARBITRUM_ONE.NETWORK_STRING, ARBITRUM_ONE.UNISWAP_PATH_OVERRIDE);
UNISWAP_PATH_OVERRIDES.set(POLYGON.NETWORK_STRING, POLYGON.QUICKSWAP_PATH_OVERRIDE);
...
YEARN_LENS_CONTRACT_ADDRESS.set(BSC.NETWORK_STRING, BSC.YEARN_LENS_CONTRACT_ADDRESS);
...
YEARN_LENS_CONTRACT_ADDRESS.set(POLYGON.NETWORK_STRING, POLYGON.YEARN_LENS_CONTRACT_ADDRESS);
...
CHAIN_LINK_CONTRACT_ADDRESS.set(BSC.NETWORK_STRING, BSC.CHAIN_LINK_CONTRACT_ADDRESS);
...
CHAIN_LINK_CONTRACT_ADDRESS.set(POLYGON.NETWORK_STRING, POLYGON.CHAIN_LINK_CONTRACT_ADDRESS);
