...
export const PROTOCOL_NAME = "Level Finance";
export const PROTOCOL_SLUG = "LVL";
...
export const LEVEL_STAKE_ADDRESS = Address.fromString(
  "0x08a12ffedf49fa5f149c73b07e31f99249e40869"
);
