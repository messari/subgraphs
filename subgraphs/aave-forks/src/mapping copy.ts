...
export function _handleReserveDataUpdated(
  ...
  log.info(
    "[_handleReserveDataUpdated]liquidityIndex={},market._liquidityIndex={},liquidityIndexDiff={} tx {}-{}",
    [
      liquidityIndex.toString(),
      market._liquidityIndex!.toString(),
  ...
  log.info("[_handleReserveDataUpdated]market {} market._liquidityIndex={}", [
    market.id.toHexString(),
    market._liquidityIndex!.toString(),
  ]);
  ...
  log.info(
    "[_handleReserveDataUpdated]scaledSupply={},liquidityIndexDiff={},decimals={},price={},newRevenueBD={},totalRevenueDeltaUSD={}",
    [
      tryScaledSupply.value.toString(),
      liquidityIndexDiff.toString(),
  ...
  flashloanPremium.save();
  log.info("[_handleReserveDataUpdated]totalRevenueDeltaUSD {}", [
    totalRevenueDeltaUSD.toString(),
  ]);
  log.info("[_handleReserveDataUpdated]market {} market._liquidityIndex={}", [
    market.id.toHexString(),
  ...
  log.info("[_handleReserveDataUpdated]addProtocolRevenue {} {} tx {}-{}", [
    FeeType.PROTOCOL_FEE,
  ...
  log.info("[_handleReserveDataUpdated]addSupplyRevenue {} {} tx {}-{}", [
    FeeType.PROTOCOL_FEE,
...
export function _handleLiquidate(
  ...
  log.info("[_handleLiquidate]addProtocolRevenue {} {}", [
    FeeType.LIQUIDATION_FEE,
    liquidationProtocolFeeUSD.toString(),
  ]);
...
export function _handleFlashLoan(
  ...
  log.info(
    "[_handleFlashLoan]tx {}-{}: premiumAmount={},premiumUSDTotal={},priceUSD={},token={}",
    [
      event.transaction.hash.toHexString(),
      event.transactionLogIndex.toString(),
      premiumAmount.toString(),
      premiumUSDTotal.toString(),
      tokenManager.getPriceUSD().toString(),
      tokenManager.getToken().symbol,
    ]
  );
  ...
  log.info(
    "[_handleFlashLoan]tx {}-{}: premiumUSDToProtocol={},premiumUSDToLP={},premiumRateToProtocol={},premiumRateToLP={}",
    [
      event.transaction.hash.toHexString(),
      event.transactionLogIndex.toString(),
      premiumUSDToProtocol.toString(),
      premiumUSDToLP.toString(),
      premiumRateToProtocol.toString(),
      premiumRateToLP.toString(),
    ]
  );
  ...
  log.info("[_handleFlashLoan]addProtocolRevenue {} {}", [
    FeeType.FLASHLOAN_PROTOCOL_FEE,
    premiumUSDToProtocol.toString(),
  ]);
  ...
  log.info("[_handleFlashLoan]addSupplyRevenue {} {}", [
    FeeType.FLASHLOAN_LP_FEE,
    premiumUSDToLP.toString(),
  ]);
