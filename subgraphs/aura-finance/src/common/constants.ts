...
export const PROTOCOL_NAME = "Aura Finance";
export const PROTOCOL_SLUG = "aura-finance";
...
export const BIGDECIMAL_1E18 = new BigDecimal(BIGINT_TEN.pow(18));
...
export const BAL_TOKEN_ADDR = Address.fromString(
