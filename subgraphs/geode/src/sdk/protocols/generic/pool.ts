...
export class Pool {
  ...
  getIds(): BigInt[] {
    return this.pool._ids;
  }

  setWithdrawalPools(pools: Bytes[]): void {
    this.pool._withdrawalPools = pools;
    this.save();
  }

  getWithdrawalPools(): Bytes[] {
    return this.pool._withdrawalPools;
  }
}
