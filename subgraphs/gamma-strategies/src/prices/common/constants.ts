...
USDC_DECIMALS_MAP.set(MAINNET.NETWORK_STRING, BigInt.fromI32(MAINNET.USDC_DECIMALS));
USDC_DECIMALS_MAP.set(BSC.NETWORK_STRING, BigInt.fromI32(BSC.USDC_DECIMALS));
USDC_DECIMALS_MAP.set(FANTOM.NETWORK_STRING, BigInt.fromI32(FANTOM.USDC_DECIMALS));
USDC_DECIMALS_MAP.set(ARBITRUM_ONE.NETWORK_STRING, BigInt.fromI32(ARBITRUM_ONE.USDC_DECIMALS));
USDC_DECIMALS_MAP.set(POLYGON.NETWORK_STRING, BigInt.fromI32(POLYGON.USDC_DECIMALS));
