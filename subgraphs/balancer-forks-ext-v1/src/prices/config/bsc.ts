...
export const SUSHISWAP_WETH_ADDRESS = Address.fromString("0x0000000000000000000000000000000000000000");

export const SUSHISWAP_ROUTER_ADDRESS = new TypedMap<string, Address>();
SUSHISWAP_ROUTER_ADDRESS.set("routerV1", Address.fromString("0x0000000000000000000000000000000000000000"));
...
export const USDC_DECIMALS = BigInt.fromI32(18);

export const WHITELIST_TOKENS = new TypedMap<string, Address>();
WHITELIST_TOKENS.set("WETH", Address.fromString("0xbb4cdb9cbd36b01bd1cbaebf2de08d9173bc095c"));
WHITELIST_TOKENS.set("USDT", Address.fromString("0x55d398326f99059ff775485246999027b3197955"));
WHITELIST_TOKENS.set("DAI", Address.fromString("0x1af3f329e8be154074d8769d1ffa4ee058b1dbc3"));
WHITELIST_TOKENS.set("USDC", Address.fromString("0x8ac76a51cc950d9822d68b83fe1ad97b32cd580d"));
WHITELIST_TOKENS.set("ETH", Address.fromString("0x2170ed0880ac9a755fd29b2688956bd959f933f8"));
WHITELIST_TOKENS.set("WBTC", Address.fromString("0x7130d2a12b9bcbfae4f2634d864a1ee1ce3ead9c"));
WHITELIST_TOKENS.set("EURS", Address.fromString("0x0000000000000000000000000000000000000000"));
WHITELIST_TOKENS.set("LINK", Address.fromString("0xf8a0bf9cf54bb92f17374d9e9a321e6a111a51bd"));
