...
import {
  ...
  ProposalQueued,
  VoteCast,
} from "../../../generated/GovernorBeta/GovernorBeta";
import {
...
import { GovernorBeta } from "../../../generated/GovernorBeta/GovernorBeta";
...
function getLatestProposalValues(
  ...
  if (proposal.state == ProposalState.PENDING) {
    const contract = GovernorBeta.bind(contractAddress);
...
function getGovernanceFramework(contractAddress: string): GovernanceFramework {
  ...
  if (!governanceFramework) {
    ...
    governanceFramework.tokenAddress = contract.ctx().toHexString();
