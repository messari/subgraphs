...
import { WBETH } from "../../generated/OraStakeRouter/WBETH";
import { PendlePT } from "../../generated/OraStakeRouter/PendlePT";
import { PendleSY } from "../../generated/OraStakeRouter/PendleSY";
import { EigenpieMLRT } from "../../generated/OraStakeRouter/EigenpieMLRT";
import { SFRAX } from "../../generated/OraStakeRouter/SFRAX";
  ...
  if (network == Network.MAINNET) {
    ...
    if (
      [
        ...
        Address.fromString("0xd5f7838f5c461feff7fe49ea5ebaf7728bb0adfa"),
    ...
    // Case: inputToken is sUSDz
    if (
      [
        Address.fromString("0x547213367cfb08ab418e7b54d7883b2c2aa27fd7"),
      ].includes(pricedToken)
    ) {
