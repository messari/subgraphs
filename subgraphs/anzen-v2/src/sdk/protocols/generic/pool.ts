...
export class Pool {
  ...
  initialize(
    ...
    this.pool._mintFeeRate = BIGINT_ZERO;
    this.pool._redeemFeeRate = BIGINT_ZERO;
  ...
  setMintFeeRate(rate: BigInt): void {
    this.pool._mintFeeRate = rate;
    this.save();
  }

  getMintFeeRate(): BigInt {
    return this.pool._mintFeeRate;
  }

  setRedeemFeeRate(rate: BigInt): void {
    this.pool._redeemFeeRate = rate;
    this.save();
  }

  getRedeemFeeRate(): BigInt {
    return this.pool._redeemFeeRate;
  }
}
