...
export class Pool {
  ...
  initialize(
    ...
    this.pool.cumulativeSupplySideRevenue = BIGINT_ZERO;
    this.pool.cumulativeSupplySideRevenueUSD = BIGDECIMAL_ZERO;
    this.pool.cumulativeProtocolSideRevenue = BIGINT_ZERO;
  ...
  addRevenueNative(
    ...
    this.pool.cumulativeSupplySideRevenue =
      this.pool.cumulativeSupplySideRevenue.plus(supplySide);

    this.addRevenueUSD(pAmountUSD, sAmountUSD);
  }

  getRevenueUSD(): BigDecimal[] {
    return [
      this.pool.cumulativeProtocolSideRevenueUSD,
      this.pool.cumulativeSupplySideRevenueUSD,
    ];
