...
export const PROTOCOL_NAME = "Eigen Layer";
export const PROTOCOL_SLUG = "eigenlayer";
...
export namespace ProtocolType {
  ...
  export const RESTAKING = "RESTAKING";
}

export namespace PoolType {
  export const EIGEN_POD = "EIGEN_POD";
...
export const WITHDRAWAL_QUEUED_DATA_TYPE =
