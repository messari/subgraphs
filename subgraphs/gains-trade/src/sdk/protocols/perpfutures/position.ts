...
class LoadPositionResponse {
  ...
  constructor(position: Position, isExistingOpenPosition: boolean) {
    this.position = position;
    this.isExistingOpenPosition = isExistingOpenPosition;
  }
}
...
export class PositionManager {
  ...
  loadPosition(
    ...
    return new LoadPositionResponse(position, isExistingOpenPosition);
  }
}
...
export class Position {
  ...
  closePosition(isExistingOpenPosition: boolean): void {
    const event = this.protocol.getCurrentEvent();
    ...
    this.account.closePosition(this.position.side, isExistingOpenPosition);
    this.pool.closePosition(this.position.side, isExistingOpenPosition);
    this.protocol.closePosition(this.position.side, isExistingOpenPosition);
  }
