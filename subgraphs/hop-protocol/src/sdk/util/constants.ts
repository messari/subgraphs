...
export namespace MainnetToken {
  ...
  export const MAGIC =
    "0xb0c7a3ba49c7a6eaba6cd4a96c55a1391070ac9a".toLowerCase();
}
...
export namespace MainnetBridge {
  ...
  export const MAGIC =
    "0xf074540eb83c86211f305e145eb31743e228e57d".toLowerCase();
}
...
export namespace ArbitrumBridge {
  ...
  export const MAGIC =
    "0xea5abf2c909169823d939de377ef2bf897a6ce98".toLowerCase();
}
export namespace ArbitrumAmm {
  ...
  export const MAGIC =
    "0x50a3a623d00fd8b8a4f3cbc5aa53d0bc6fa912dd".toLowerCase();
}
...
export namespace ArbitrumNovaBridge {
  export const ETH = "0x0e0e3d2c5c292161999474247956ef542cabf8dd".toLowerCase();
  export const MAGIC =
    "0x72209fe68386b37a40d6bca04f78356fd342491f".toLowerCase();
}
