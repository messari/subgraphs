...
export namespace XdaiBridge {
	...
	export const WBTC = '0x07C592684Ee9f71D58853F9387579332d471b6Ca'.toLowerCase()
	export const HOP = '0x6F03052743CD99ce1b29265E377e320CD24Eb632'.toLowerCase()
}
export namespace XdaiAmm {
	...
	export const WBTC = '0xb07c6505e1E41112494123e40330c5Ac09817CFB'.toLowerCase()
}
...
export namespace MainnetToken {
	...
	export const WBTC = '0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599'.toLowerCase()
...
export namespace MainnetBridge {
	...
	export const WBTC = '0xb98454270065A31D71Bf635F6F7Ee6A518dFb849'.toLowerCase()
	...
	export const HOP = '0x914f986a44AcB623A277d6Bd17368171FCbe4273'.toLowerCase()
}
...
export namespace ArbitrumBridge {
	...
	export const WBTC = '0x3E4a3a4796d16c0Cd582C382691998f7c06420B6'.toLowerCase()
	export const HOP = '0x25FB92E505F752F730cAD0Bd4fa17ecE4A384266'.toLowerCase()
}
export namespace ArbitrumAmm {
	...
	export const WBTC = '0x7191061D5d4C60f598214cC6913502184BAddf18'.toLowerCase()
}
...
export namespace ArbitrumToken {
	...
	export const WBTC = '0x2f2a2543B76A4166549F7aaB2e75Bef0aefC5B0f'.toLowerCase()
	export const HOP = '0xc5102fE9359FD9a28f877a67E36B0F050d81a3CC'.toLowerCase()
}
...
export namespace OptimismBridge {
	...
	export const WBTC = '0xB1ea9FeD58a317F81eEEFC18715Dd323FDEf45c4'.toLowerCase()
	...
	export const HOP = '0x03D7f750777eC48d39D080b020D83Eb2CB4e3547'.toLowerCase()
}
export namespace OptimismAmm {
	...
	export const WBTC = '0x46fc3Af3A47792cA3ED06fdF3D657145A675a8D8'.toLowerCase()
}
...
export namespace OptimismToken {
	...
	export const WBTC = '0x68f180fcCe6836688e9084f035309E29Bf0A2095'.toLowerCase()
...
export namespace PolygonBridge {
	...
	export const WBTC = '0x91Bd9Ccec64fC22475323a0E55d58F7786587905'.toLowerCase()
	export const MATIC =
		'0x553bC791D746767166fA3888432038193cEED5E2'.toLowerCase()
	export const HOP = '0x58c61AeE5eD3D748a1467085ED2650B697A66234'.toLowerCase()
}
export namespace PolygonAmm {
	...
	export const WBTC = '0x4e9840f3C1ff368a10731D15c11516b9Fe7E1898'.toLowerCase()
	export const MATIC =
		'0x3d4Cc8A61c7528Fd86C55cfe061a78dCBA48EDd1'.toLowerCase()
	export const HOP = '0xc5102fE9359FD9a28f877a67E36B0F050d81a3CC'.toLowerCase()
}
...
export namespace PolygonToken {
	...
	export const WBTC = '0x1BFD67037B42Cf73acF2047067bd4F2C47D9BfD6'.toLowerCase()
	export const MATIC =
