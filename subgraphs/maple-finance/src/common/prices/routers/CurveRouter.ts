...
import { CurveRegistry as CurveRegistryContract } from "../../../../generated/MapleGlobals/CurveRegistry";
...
export function getCurvePriceUsdc(curveLpTokenAddress: Address, network: string): CustomPriceType {
    ...
    let price = virtualPrice
        ...
        .div(
            constants.BIGINT_TEN.pow(decimalsAdjustment.plus(constants.DEFAULT_DECIMALS).toI32() as u8).toBigDecimal()
        );
