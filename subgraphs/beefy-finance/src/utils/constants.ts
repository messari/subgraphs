...
export const PROTOCOL_ID = "beefy-finance";
export const PROTOCOL_NAME = "Beefy Finance";
export const PROTOCOL_SLUG = "beefy-finance";
...
// hardcoded native token addresses
// native token is what is what revenue is distrubuted in
