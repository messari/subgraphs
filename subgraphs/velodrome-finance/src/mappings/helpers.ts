...
// import { PairFactory as FactoryContract } from "../../generated/PairFactory/PairFactory";
import {
  BIGDECIMAL_ONE,
  BIGDECIMAL_TWO,
  BIGDECIMAL_ZERO,
...
export function createDeposit(
  ...
  deposit.from = sender.toHex()
  deposit.blockNumber = event.block.number
  deposit.timestamp = event.block.timestamp
  deposit.inputTokens = [pairContract.token0.toString(), pairContract.token1.toString()]
  deposit.outputToken =
