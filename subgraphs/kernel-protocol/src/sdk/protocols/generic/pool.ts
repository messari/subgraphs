...
export class Pool {
  ...
  initialize(
    ...
    this.pool._mintFee = BIGINT_ZERO;
    this.pool._redeemFee = BIGINT_ZERO;
    this.save();
  ...
  setMintFee(value: BigInt): void {
    this.pool._mintFee = value;
    this.save();
  }

  setRedeemFee(value: BigInt): void {
    this.pool._redeemFee = value;
    this.save();
  }

  getFee(): BigInt[] {
    return [this.pool._mintFee, this.pool._redeemFee];
  }
}
