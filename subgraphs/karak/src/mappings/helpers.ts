...
import {
  ...
  BTC_ADDRESS as BTC_ADDRESS_BSC,
...
import { WBETH } from "../../generated/VaultSupervisor/WBETH";
import { PendlePT } from "../../generated/VaultSupervisor/PendlePT";
import { PendleSY } from "../../generated/VaultSupervisor/PendleSY";
import { EigenpieMLRT } from "../../generated/VaultSupervisor/EigenpieMLRT";
import { SFRAX } from "../../generated/VaultSupervisor/SFRAX";
...
export function getUpdatedPricedToken(tokenAddr: Address): PricedTokenParams {
  ...
  if (network == Network.ARBITRUM_ONE) {
    // Case: inputToken is weETH or ezETH or Pendle PT-eth tokens
    if (
      [
  ...
  if (network == Network.BSC) {
    ...
    // Case: inputToken is SolvBTC
    if (
      [
        Address.fromString("0x4aae823a6a0b376de6a78e74ecc5b079d38cbcf7"),
      ].includes(pricedToken)
    ) {
      pricedToken = BTC_ADDRESS_BSC;
      changed = true;
    }
  }
