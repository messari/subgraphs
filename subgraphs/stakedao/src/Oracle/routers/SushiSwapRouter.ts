...
} from "../../../generated/Controller/SushiSwapPair";
import { SushiSwapRouter as SushiSwapRouterContract } from "../../../generated/Controller/SushiSwapRouter";
...
export function getLpTokenPriceUsdc(
  ...
  let totalLiquidity: BigDecimal = getLpTokenTotalLiquidityUsdc(
    tokenAddress,
    network
  );
