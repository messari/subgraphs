...
* Bancor V3 Technical Docs: [Bancor V3 Technical Docs](https://docs.bancor.network/about-bancor-network/bancor-v)
...
* Bancor V3 Presentation by Mark Richardson (Head of Bancor Research): 
...
Protocol Controlled Value is relevant for Bancor V3. 

The formula for the protocol controlled value for Bancor V3 will be as follows:

_Total Protocol Controlled Value USD = Amount of vBNT Burned * Latest price of BNT in USD_
