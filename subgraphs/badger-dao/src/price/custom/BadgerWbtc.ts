...
import { ChainLinkSolo } from "../../../generated/bcrvBADGER/ChainLinkSolo";
import { PoolContract } from "../../../generated/bcrvBADGER/PoolContract";
...
export function getUsdPriceOfBadgerWbtcToken(tokenAddress: Address): CustomPriceType {
  ...
  return CustomPriceType.initialize(priceOfToken, BIGINT_ZERO);
}
