...
import { updateFinancialMetrics, updateUsageMetrics, updateVault, updateVaultMetrics } from "./common";
...
export function handleTransfer(event: Transfer): void {
  ...
  let tokenPriceUSD = normalizedUsdcPrice(
    getPriceOfCurveLpToken(tokenAddress, event.params.value, BigInt.fromI32(token.decimals)),
  );
