...
import { UniswapV3Pool } from "../../generated/Registry/UniswapV3Pool";
...
export function getLPTPrice(ethPriceUSD: BigDecimal): BigDecimal {
  const pair = Address.fromString("0x4fd47e5102dfbf95541f64ed6fe13d4ed26d2546"); // LPT/ETH
  const lptPriceEth = getPriceForPair(pair);
