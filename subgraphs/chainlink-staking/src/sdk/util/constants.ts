...
export const BIGDECIMAL_EIGHTEEN = new BigDecimal(BIGINT_EIGHTEEN);
export const BIGDECIMAL_HUNDRED = new BigDecimal(BIGINT_HUNDRED);
export const BIGDECIMAL_TEN_TO_EIGHTEENTH = new BigDecimal(
...
export const SECONDS_PER_YEAR = 60 * 60 * 24 * 365; // 31536000
...
export const SECONDS_PER_YEAR_BI = BigInt.fromI32(SECONDS_PER_YEAR);
