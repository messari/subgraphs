...
=======
  totalValueLockedUSD:
    "This field on 'Protocol' entity has a value below $0 or above $100,000,000,000.",
  ...
  cumulativeUniqueUsers:
    "This field on 'Protocol' entity has a value below 0 or greater than 100,000,000.",
  totalPoolCount:
    "This field on 'Protocol' entity has less than 0 pools or more than 10,000 pools.",
  cumulativeUniqueDepositors:
    "'Protocol' entity has fewer cumulativeUniqueUsers than cumulativeUniqueDepositors.",
  ...
  openPositionCount:
    "This field on 'Protocol' entity has a value below 0 or greater than 1,000,000,000.",
  cumulativePositionCount:
    "'Protocol' entity has a lower openPositionCount than cumulativePositionCount.",
  totalDepositBalanceUSD:
    "This field on 'Protocol' entity has a value less than $0 or greater than $100,000,000,000.",
  ...
  protocolEntity: "'Protocol' entity has zero instances.",
  relatedField:
    "This field on 'Protocol' entity is supposed to hold related instances of another entity, however no instances were successfully linked.",
  queryError: "Querying the 'Protocol' entity returned error messages.",
...
export const poolErrorMessages = {
  totalValueLockedUSD:
    "The pools listed have a TVL below $0 or above $100,000,000,000.",
  cumulativeSupplySideRevenueUSD:
    "The pools listed have a cumulativeSupplySideRevenueUSD below $0 or above $10,000,000,000.",
  cumulativeProtocolSideRevenueUSD:
    "The pools listed have a cumulativeProtocolSideRevenueUSD below $0 or above $10,000,000,000.",
  cumulativeTotalRevenueUSD:
  ...
  totalDepositBalanceUSD:
    "The pools listed have a totalDepositBalanceUSD below $0 or above $100,000,000,000.",
  totalBorrowBalanceUSD:
  ...
  outputTokenPriceUSD:
    "The pools listed have an outputTokenPriceUSD value below $0 or above $100,000",
  cumulativeVolumeUSD:
    "The pools listed have a cumulativeVolumeUSD value below $0 or above $10,000,000,000.",
};
